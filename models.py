...
class UserInput(BaseModel):
    ...
    weight: Annotated[float, Field(..., gt=0, lt=250, description="Weight in kg")]
    ...
    occupation: Annotated[
        Literal['retired', 'freelancer', 'student', 'government_job', 'unemployed', 'private_job', 'business_owner'],
    ...
    def city_tier(self) -> int:
        city_clean = self.city.strip().title()
