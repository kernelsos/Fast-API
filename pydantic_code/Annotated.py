...
class Patient(BaseModel):
    ...
    allergies: Annotated[List[str], Field(max_length=10, default=None, title="Names of the allergies",description="Give the name of the allergies",examples=["Pollen","Dust"])]
